...
- Variables in the function prototype can be used in the function and are known only in the function 
- When parameters are passed by value, modifications within the function do not affect the original variables passed.
- When parameters are passed by reference, the modifications directly change the original variables.
